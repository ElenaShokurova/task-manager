...
export const addListenerOnce = function (document) {
    document.querySelector(".button-add-backlog").addEventListener("click", function(e){
        ...
        const submitBtn = document.querySelector(".button-submit-backlog");
        const addBtn = document.querySelector(".button-add-backlog");
    ...
    document.querySelector(".button-submit-backlog").addEventListener("click", function (e) {
        const inputTask = document.querySelector(".input-task-backlog");
        const submitBtn = document.querySelector(".button-submit-backlog");
        const addBtn = document.querySelector(".button-add-backlog");
